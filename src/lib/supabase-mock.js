  ...
  complaints: [
    {
      ...
      history: [
        {
          timestamp: daysAgo(4, 14, 20),
          date: '01/09/2026, 02:20 PM',
          officer_name: 'System / Ramesh Kumar',
          from_status: 'none',
          to_status: 'submitted',
          action: 'Dispute Filed',
          notes: 'Claim registered by worker for 2 hours unpaid overtime rewiring.',
        },
        {
          timestamp: daysAgo(2, 10, 15),
          date: '02/09/2026, 10:15 AM',
          officer_name: 'Sanjay Verma (Labor Officer)',
          from_status: 'submitted',
          to_status: 'under review',
          action: 'Marked Under Review',
          notes: 'Cross-referencing site GPS logs and work completion photo.',
        },
      ],
    ...
    },
    {
      ...
      history: [
        {
          timestamp: daysAgo(7, 16, 45),
          date: '28/08/2026, 04:45 PM',
          officer_name: 'System / Mohammad Irfan',
          from_status: 'none',
          to_status: 'submitted',
          action: 'Safety Hazard Reported',
          notes: 'Worker reported uninsulated domestic live riser without main switch isolation.',
        },
        {
          timestamp: daysAgo(5, 11, 30),
          date: '30/08/2026, 11:30 AM',
          officer_name: 'Sanjay Verma (Labor Officer)',
          from_status: 'submitted',
          to_status: 'under review',
          action: 'Marked Under Review',
          notes: 'Initial hazard assessment initiated.',
        },
        {
          timestamp: daysAgo(3, 11, 0),
          date: '01/09/2026, 11:00 AM',
          officer_name: 'Sanjay Verma (Labor Officer)',
          from_status: 'under review',
          to_status: 'in progress',
          action: 'Investigation Escalated',
          notes: 'Safety inspection scheduled with zonal engineer.',
        },
      ],
    ...
    },
    {
      ...
      history: [
        {
          timestamp: daysAgo(15, 9, 30),
          date: '20/08/2026, 09:30 AM',
          officer_name: 'System / Priya Sharma',
          from_status: 'none',
          to_status: 'submitted',
          action: 'Service Dispute Registered',
          notes: 'Customer reported leakage 24 hours post-completion.',
        },
        {
          timestamp: daysAgo(12, 17, 0),
          date: '23/08/2026, 05:00 PM',
          officer_name: 'Sanjay Verma (Labor Officer)',
          from_status: 'submitted',
          to_status: 'resolved',
          action: 'Case Resolved with Warranty Repair',
          notes: 'Worker re-visited site under warranty and applied secondary epoxy seal at no additional charge.',
        },
      ],
    ...
    },
    {
      ...
      history: [
        {
          timestamp: daysAgo(1, 18, 10),
          date: '03/09/2026, 06:10 PM',
          officer_name: 'System / Sunita Devi',
          from_status: 'none',
          to_status: 'submitted',
          action: 'Workplace Incident Reported',
          notes: 'Worker filed incident report regarding verbal abuse and refusal to sign form.',
        },
      ],
